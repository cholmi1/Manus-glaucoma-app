...
describe("감사 로그 해시 체인", () => {
  const entry = { organizationId: 1, actorUserId: "11111111-1111-4111-8111-111111111111", patientId: 11, action: "view", targetType: "iop_measurement", targetId: "55", detail: { eye: "OD", range: "7d" } };
